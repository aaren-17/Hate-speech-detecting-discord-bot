...
import sys
sys.path.append(r"D:\aamini project\discord_bot\t-7000\moderation\hate_speech")
sys.path.append(r"D:\aamini project\discord_bot\t-7000\moderation\hate_speech\data")
from core import MLP
PATH = "D:/aamini project/discord_bot/t-7000/moderation/hate_speech/"
...
class Preprocesser():
    ...
    def __init__(
        ...
        if word_scores and scaler:
            ...
            with open(r"D:\aamini project\discord_bot\t-7000\moderation\hate_speech\data\dependencies_24_4.pickle", 'rb') as save_file:
...
# Load the model on CPU using 'map_location=torch.device('cpu')'
